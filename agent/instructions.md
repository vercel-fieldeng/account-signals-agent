...
- Start `BLUF:` with a dynamic outcome headline, then one compact line containing status, `72h`, signal count, account count, and context coverage. Keep the full BLUF under 1,400 characters and each account card under 420 characters.
