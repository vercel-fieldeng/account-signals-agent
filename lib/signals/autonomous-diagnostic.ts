...
If d0, careers, or company-news retrieval is still working, incomplete, or failed, render \`Status: PARTIAL\` or \`Status: BLOCKED\` in the BLUF/detail and state exactly which source is pending or unavailable. Never write \`No actionable findings\` as the final conclusion unless all required sources completed successfully.
